...
/*    @Override
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        switch(option){
            case 0: mLayoutManager=new LinearLayoutManager(getActivity());
                break;
            case 1: mLayoutManager=new GridLayoutManager(getActivity(),3);
                break;
            default:mLayoutManager=new LinearLayoutManager(getActivity());
                break;
        }
